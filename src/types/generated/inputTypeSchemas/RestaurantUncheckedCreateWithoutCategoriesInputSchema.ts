...
export const RestaurantUncheckedCreateWithoutCategoriesInputSchema: z.ZodType<Prisma.RestaurantUncheckedCreateWithoutCategoriesInput> =
  z
    .object({
      ...
      createdBy: z.string(),
      reviews: z
        .lazy(() => ReviewUncheckedCreateNestedManyWithoutRestaurantInputSchema)
        .optional(),
    })
    .strict();
