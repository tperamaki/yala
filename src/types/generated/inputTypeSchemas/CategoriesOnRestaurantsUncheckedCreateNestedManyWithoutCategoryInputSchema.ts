...
export const CategoriesOnRestaurantsUncheckedCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
