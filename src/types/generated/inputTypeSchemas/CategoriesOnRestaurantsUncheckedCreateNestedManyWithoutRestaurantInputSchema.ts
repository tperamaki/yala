...
export const CategoriesOnRestaurantsUncheckedCreateNestedManyWithoutRestaurantInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsUncheckedCreateNestedManyWithoutRestaurantInput> =
  z
    .object({
      create: z
        .union([
