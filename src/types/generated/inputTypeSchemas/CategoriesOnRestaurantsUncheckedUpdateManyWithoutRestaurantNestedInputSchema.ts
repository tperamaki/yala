...
export const CategoriesOnRestaurantsUncheckedUpdateManyWithoutRestaurantNestedInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsUncheckedUpdateManyWithoutRestaurantNestedInput> =
  z
    .object({
      create: z
        .union([
