...
export const CategoriesOnRestaurantsUncheckedUpdateManyWithoutRestaurantNestedInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsUncheckedUpdateManyWithoutRestaurantNestedInput> = z.object({
  create: z.union([ z.lazy(() => CategoriesOnRestaurantsCreateWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsCreateWithoutRestaurantInputSchema).array(),z.lazy(() => CategoriesOnRestaurantsUncheckedCreateWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsUncheckedCreateWithoutRestaurantInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => CategoriesOnRestaurantsCreateOrConnectWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsCreateOrConnectWithoutRestaurantInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => CategoriesOnRestaurantsUpsertWithWhereUniqueWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsUpsertWithWhereUniqueWithoutRestaurantInputSchema).array() ]).optional(),
  createMany: z.lazy(() => CategoriesOnRestaurantsCreateManyRestaurantInputEnvelopeSchema).optional(),
  ...
  update: z.union([ z.lazy(() => CategoriesOnRestaurantsUpdateWithWhereUniqueWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsUpdateWithWhereUniqueWithoutRestaurantInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CategoriesOnRestaurantsUpdateManyWithWhereWithoutRestaurantInputSchema),z.lazy(() => CategoriesOnRestaurantsUpdateManyWithWhereWithoutRestaurantInputSchema).array() ]).optional(),
...
export default CategoriesOnRestaurantsUncheckedUpdateManyWithoutRestaurantNestedInputSchema;
