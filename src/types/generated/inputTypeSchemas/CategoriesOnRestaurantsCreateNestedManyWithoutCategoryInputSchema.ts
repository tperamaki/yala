...
export const CategoriesOnRestaurantsCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
