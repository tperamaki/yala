...
export const CategoriesOnRestaurantsWhereUniqueInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsWhereUniqueInput> =
  z
    .object({
      categoryId_restaurantId: z.lazy(
        () =>
          CategoriesOnRestaurantsCategoryIdRestaurantIdCompoundUniqueInputSchema,
      ),
    })
    .and(
      z
        .object({
          categoryId_restaurantId: z
            .lazy(
              () =>
                CategoriesOnRestaurantsCategoryIdRestaurantIdCompoundUniqueInputSchema,
            )
          ...
          AND: z
            .union([
              z.lazy(() => CategoriesOnRestaurantsWhereInputSchema),
              z.lazy(() => CategoriesOnRestaurantsWhereInputSchema).array(),
            ])
            .optional(),
          OR: z
            .lazy(() => CategoriesOnRestaurantsWhereInputSchema)
            .array()
            .optional(),
          NOT: z
            .union([
          ...
          restaurant: z
            .union([
              z.lazy(() => RestaurantRelationFilterSchema),
