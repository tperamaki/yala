...
export const CategoriesOnRestaurantsScalarWhereInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => CategoriesOnRestaurantsScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
