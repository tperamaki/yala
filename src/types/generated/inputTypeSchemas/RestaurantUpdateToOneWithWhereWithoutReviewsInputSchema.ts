...
export const RestaurantUpdateToOneWithWhereWithoutReviewsInputSchema: z.ZodType<Prisma.RestaurantUpdateToOneWithWhereWithoutReviewsInput> = z.object({
  where: z.lazy(() => RestaurantWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => RestaurantUpdateWithoutReviewsInputSchema),z.lazy(() => RestaurantUncheckedUpdateWithoutReviewsInputSchema) ]),
}).strict();
