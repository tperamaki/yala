...
export const CategoriesOnRestaurantsOrderByWithAggregationInputSchema: z.ZodType<Prisma.CategoriesOnRestaurantsOrderByWithAggregationInput> =
  z
    .object({
      ...
      assignedBy: z
        ...
        .optional(),
      _count: z
        .lazy(() => CategoriesOnRestaurantsCountOrderByAggregateInputSchema)
        .optional(),
      _avg: z
        .lazy(() => CategoriesOnRestaurantsAvgOrderByAggregateInputSchema)
        .optional(),
      _max: z
        .lazy(() => CategoriesOnRestaurantsMaxOrderByAggregateInputSchema)
        .optional(),
      _min: z
        .lazy(() => CategoriesOnRestaurantsMinOrderByAggregateInputSchema)
        .optional(),
      _sum: z
        .lazy(() => CategoriesOnRestaurantsSumOrderByAggregateInputSchema)
        .optional(),
    })
    .strict();
