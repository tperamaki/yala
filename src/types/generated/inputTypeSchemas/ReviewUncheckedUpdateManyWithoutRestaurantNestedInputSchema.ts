...
export const ReviewUncheckedUpdateManyWithoutRestaurantNestedInputSchema: z.ZodType<Prisma.ReviewUncheckedUpdateManyWithoutRestaurantNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReviewCreateWithoutRestaurantInputSchema),z.lazy(() => ReviewCreateWithoutRestaurantInputSchema).array(),z.lazy(() => ReviewUncheckedCreateWithoutRestaurantInputSchema),z.lazy(() => ReviewUncheckedCreateWithoutRestaurantInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReviewCreateOrConnectWithoutRestaurantInputSchema),z.lazy(() => ReviewCreateOrConnectWithoutRestaurantInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ReviewUpsertWithWhereUniqueWithoutRestaurantInputSchema),z.lazy(() => ReviewUpsertWithWhereUniqueWithoutRestaurantInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReviewCreateManyRestaurantInputEnvelopeSchema).optional(),
  ...
  update: z.union([ z.lazy(() => ReviewUpdateWithWhereUniqueWithoutRestaurantInputSchema),z.lazy(() => ReviewUpdateWithWhereUniqueWithoutRestaurantInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReviewUpdateManyWithWhereWithoutRestaurantInputSchema),z.lazy(() => ReviewUpdateManyWithWhereWithoutRestaurantInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReviewScalarWhereInputSchema),z.lazy(() => ReviewScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReviewUncheckedUpdateManyWithoutRestaurantNestedInputSchema;
