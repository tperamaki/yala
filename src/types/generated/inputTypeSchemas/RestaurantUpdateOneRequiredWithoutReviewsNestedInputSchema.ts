...
export const RestaurantUpdateOneRequiredWithoutReviewsNestedInputSchema: z.ZodType<Prisma.RestaurantUpdateOneRequiredWithoutReviewsNestedInput> = z.object({
  ...
  upsert: z.lazy(() => RestaurantUpsertWithoutReviewsInputSchema).optional(),
  connect: z.lazy(() => RestaurantWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => RestaurantUpdateToOneWithWhereWithoutReviewsInputSchema),z.lazy(() => RestaurantUpdateWithoutReviewsInputSchema),z.lazy(() => RestaurantUncheckedUpdateWithoutReviewsInputSchema) ]).optional(),
}).strict();
