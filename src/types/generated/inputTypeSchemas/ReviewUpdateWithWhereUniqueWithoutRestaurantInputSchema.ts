...
export const ReviewUpdateWithWhereUniqueWithoutRestaurantInputSchema: z.ZodType<Prisma.ReviewUpdateWithWhereUniqueWithoutRestaurantInput> = z.object({
  where: z.lazy(() => ReviewWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ReviewUpdateWithoutRestaurantInputSchema),z.lazy(() => ReviewUncheckedUpdateWithoutRestaurantInputSchema) ]),
}).strict();
