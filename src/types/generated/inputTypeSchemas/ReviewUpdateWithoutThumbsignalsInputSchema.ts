...
export const ReviewUpdateWithoutThumbsignalsInputSchema: z.ZodType<Prisma.ReviewUpdateWithoutThumbsignalsInput> = z.object({
  ...
  restaurant: z.lazy(() => RestaurantUpdateOneRequiredWithoutReviewsNestedInputSchema).optional()
}).strict();

export default ReviewUpdateWithoutThumbsignalsInputSchema;
