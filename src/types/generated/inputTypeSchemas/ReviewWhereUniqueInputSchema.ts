...
export const ReviewWhereUniqueInputSchema: z.ZodType<Prisma.ReviewWhereUniqueInput> =
  z
    .object({
      restaurantId_createdBy: z.lazy(
        () => ReviewRestaurantIdCreatedByCompoundUniqueInputSchema,
      ),
    })
    .and(
      z
        .object({
          restaurantId_createdBy: z
            .lazy(() => ReviewRestaurantIdCreatedByCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
