...
export const RestaurantCreateInputSchema: z.ZodType<Prisma.RestaurantCreateInput> =
  z
    .object({
      name: z.string(),
      ...
      categories: z
        .lazy(
          () =>
            CategoriesOnRestaurantsCreateNestedManyWithoutRestaurantInputSchema,
        )
        .optional(),
      reviews: z
        .lazy(() => ReviewCreateNestedManyWithoutRestaurantInputSchema)
        .optional(),
    })
    .strict();
