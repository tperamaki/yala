...
export const CategoriesOnRestaurantsFindFirstArgsSchema: z.ZodType<Prisma.CategoriesOnRestaurantsFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ CategoriesOnRestaurantsOrderByWithRelationInputSchema.array(),CategoriesOnRestaurantsOrderByWithRelationInputSchema ]).optional(),
  cursor: CategoriesOnRestaurantsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ CategoriesOnRestaurantsScalarFieldEnumSchema,CategoriesOnRestaurantsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default CategoriesOnRestaurantsFindFirstArgsSchema;
