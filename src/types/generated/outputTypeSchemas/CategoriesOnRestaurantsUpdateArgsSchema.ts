...
export const CategoriesOnRestaurantsUpdateArgsSchema: z.ZodType<Prisma.CategoriesOnRestaurantsUpdateArgs> = z.object({
  select: CategoriesOnRestaurantsSelectSchema.optional(),
  include: CategoriesOnRestaurantsIncludeSchema.optional(),
  data: z.union([ CategoriesOnRestaurantsUpdateInputSchema,CategoriesOnRestaurantsUncheckedUpdateInputSchema ]),
