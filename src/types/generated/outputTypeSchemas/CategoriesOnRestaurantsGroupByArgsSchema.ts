...
export const CategoriesOnRestaurantsGroupByArgsSchema: z.ZodType<Prisma.CategoriesOnRestaurantsGroupByArgs> =
  z
    .object({
      where: CategoriesOnRestaurantsWhereInputSchema.optional(),
      orderBy: z
        .union([
          CategoriesOnRestaurantsOrderByWithAggregationInputSchema.array(),
          CategoriesOnRestaurantsOrderByWithAggregationInputSchema,
        ])
        .optional(),
      by: CategoriesOnRestaurantsScalarFieldEnumSchema.array(),
      having:
        CategoriesOnRestaurantsScalarWhereWithAggregatesInputSchema.optional(),
