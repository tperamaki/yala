...
export const CategoriesOnRestaurantsCreateArgsSchema: z.ZodType<Prisma.CategoriesOnRestaurantsCreateArgs> = z.object({
  select: CategoriesOnRestaurantsSelectSchema.optional(),
  include: CategoriesOnRestaurantsIncludeSchema.optional(),
  data: z.union([ CategoriesOnRestaurantsCreateInputSchema,CategoriesOnRestaurantsUncheckedCreateInputSchema ]),
}).strict() ;
