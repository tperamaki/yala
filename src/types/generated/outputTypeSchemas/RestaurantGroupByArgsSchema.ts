...
export const RestaurantGroupByArgsSchema: z.ZodType<Prisma.RestaurantGroupByArgs> =
  z
    .object({
      where: RestaurantWhereInputSchema.optional(),
      orderBy: z
        .union([
          RestaurantOrderByWithAggregationInputSchema.array(),
          RestaurantOrderByWithAggregationInputSchema,
        ])
        .optional(),
